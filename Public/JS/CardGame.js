...
var filter;
// Draw heading!
var style = { font : "bold 32px Arial", fill : "#FFD700", boundsAlignH : "center", boundsAlignV : "middle" };
var style2 = { font : "18px Times New Roman", fill : "#FFD700", boundsAlignH : "center", boundsAlignV : "middle", stroke : '#000000', strokeThickness : 0 };
...
class myCard {
    ...
    {
        if (this.name == "Beast") {
            this.myimage =  game.add.button(0, 400,'card1', this.playThis, this, 2, 1, 0);
            ...
            this.myimage =  game.add.button(0, 400, 'card3', this.playThis, this, 2, 1, 0);
            ...
            this.myimage =  game.add.button(0, 400, 'card5', this.playThis, this, 2, 1, 0);
		...
		// var myx =this.handno * 100 + 50;
		game.add.tween( this.myimage).to({ x : this.handno * 100 + 50, y: 780 }, 1780, Phaser.Easing.Bounce.Out, true);
		updateText();
        this.mybutton = game.add.button(this.myimage.x, this.myimage.y - 50, 'Play', this.playThis, this, 2, 1, 0);
		game.add.tween(  this.mybutton).to({ x : this.handno * 100 + 50, y:  780 - 50 }, 1780, Phaser.Easing.Bounce.Out, true)
    ...
    destroyCard()
    {
      //  this.myimage.destroy();
	  	game.add.tween( this.myimage).to({ x : 900, y: 400 }, 1780, Phaser.Easing.Bounce.Out, true);
...
function create()
{
    ...
    endButt = game.add.button(650, 400, 'EndTurn', endTurn, this, 2, 1, 0);
    attackButt = game.add.button(400, 400, 'Attack', actionOnClick, this, 2, 1, 0);
    drawButt = game.add.button(150, 400, 'Draw', drawCard, this, 2, 1, 0);
    crownButt = game.add.button(875, 80, 'Crown', 0, this, 2, 1, 0);
    drawCardButt = game.add.button(0, 400, 'card0', drawCard, this, 2, 1, 0);
	// scale them down
   // drawCardButt.scale.setTo(0.5, 0.5);
    ...
    text_heading2 = game.add.text(0, 50, "Created by Sam Arnold - sarnold12@liberty.edu", style2);
	// set color of background
    game.stage.backgroundColor = '#10122B';
    // prompt rules
